...
static void nrn_alloc(Prop* _prop) {
 ...
 "ca_cadifus", 1e-07,
 "bufs_cadifus", 0.001,
 "cabufs_cadifus", 1e-07,
 "bufm_cadifus", 0.0001,
 "cabufm_cadifus", 1e-08,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "ip3_ion");
  hoc_register_dparam_semantics(_mechtype, 6, "ip3_ion");
  ...
  hoc_register_dparam_semantics(_mechtype, 7, "diam");
 	...
 	ivoc_help("help ?1 cadifus /home/savtchenko/amcbridge/phase14/nano2/clusterCaSim/hpc/x86_64/cadifus.mod\n");
